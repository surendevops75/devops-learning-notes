...
# 289.1 Practical Production Drill 1: Three-AZ EKS baseline deployment
...
```text
Three-AZ EKS baseline deployment
```

without assuming that a healthy Pod equals a healthy messaging platform.

## Procedure

```text
1. Record baseline queue depth.
2. Record publish and consume rates.
3. Record consumer count.
4. Record node and Pod placement.
5. Record quorum state.
6. Execute the controlled change/failure.
7. Observe Kubernetes events.
8. Observe RabbitMQ state.
9. Observe publisher confirms.
10. Observe consumer reconnect.
11. Observe redelivery.
12. Observe queue age.
13. Observe dependency load.
14. Restore normal conditions.
15. Measure recovery time.
16. Validate message integrity.
...
```text
quorum remains healthy where expected
clients recover
messages remain safe according to RPO
duplicate business effects are prevented
queue backlog drains
no cascading dependency failure occurs
```
...
# 289.1 Practical Production Drill 2: PVC and StorageClass validation
...
# 289.1 Practical Production Drill 3: Pod anti-affinity validation
...
# 289.1 Practical Production Drill 4: Topology spread validation
...
# 289.1 Practical Production Drill 5: PDB validation
...
# 289.1 Practical Production Drill 6: node drain test
...
# 289.1 Practical Production Drill 7: Pod kill test
...
# 289.1 Practical Production Drill 8: single-AZ failure test
...
# 289.1 Practical Production Drill 9: quorum validation
...
# 289.1 Practical Production Drill 10: publisher reconnect test
...
# 289.1 Practical Production Drill 11: consumer reconnect test
...
# 289.1 Practical Production Drill 12: duplicate processing test
...
# 289.1 Practical Production Drill 13: probe failure test
...
# 289.1 Practical Production Drill 14: memory pressure test
...
# 289.1 Practical Production Drill 15: disk pressure test
...
# 289.1 Practical Production Drill 16: NetworkPolicy validation
...
# 289.1 Practical Production Drill 17: TLS rotation test
...
# 289.1 Practical Production Drill 18: secret rotation test
...
# 289.1 Practical Production Drill 19: Prometheus metrics validation
...
# 289.1 Practical Production Drill 20: Grafana dashboard validation
...
# 289.1 Practical Production Drill 21: backup test
...
# 289.1 Practical Production Drill 22: restore test
...
# 289.1 Practical Production Drill 23: RabbitMQ upgrade rehearsal
...
# 289.1 Practical Production Drill 24: EKS node upgrade rehearsal
...
# 289.1 Practical Production Drill 25: EKS version upgrade rehearsal
...
# 289.1 Practical Production Drill 26: KEDA scaling test
...
# 289.1 Practical Production Drill 27: dependency outage test
...
# 289.1 Practical Production Drill 28: retry storm test
...
# 289.1 Practical Production Drill 29: DLQ recovery test
...
# 289.1 Practical Production Drill 30: regional DR rehearsal
...
# 289.1 Practical Production Drill 31: GitOps reconciliation test
